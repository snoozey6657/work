// db/init.js - Auto-creates tables and seeds data on first startup
...
async function initDb() {
  try {
    ...
    if (parseInt(rows[0].count) === 0) {
      // Seed data uses the real agency bid-listing page as source_url.
      // Running the scraper (scraper/scrape_winnebago.py) will replace these
      // with individual bid-specific links for each live bid.
      await pool.query(`
        ...
        VALUES
        ('Rockford City Hall HVAC Replacement','Bid','HVAC','Rockford, IL',
         '2025-01-10','2025-02-15',450000,
         'Mike Torres','mtorres@rockfordil.gov','815-987-5432',
         'https://www.rockfordil.gov/Bids.aspx',
         'Full replacement of aging HVAC systems in the City Hall annex building. Includes ductwork, controls, and commissioning.'),

        ('Winnebago County Courthouse Roof Repair','Bid','Roofing','Rockford, IL',
         '2025-01-15','2025-02-28',185000,
         'Sarah Chen','schen@wincoil.us','815-319-4200',
         'https://www.wincoil.us/Government/Purchasing-Department/Open-Bids-Quotes-RFPs/',
         'Partial roof replacement on the north wing of the county courthouse. TPO membrane system preferred.'),

        ('Harlem Unified School District Electrical Upgrade','RFP','Electrical','Loves Park, IL',
         '2025-01-20','2025-03-05',720000,
         'David Park','dpark@harlemschools.org','815-654-4500',
         'https://www.harlemschools.org/district/departments/business/bid-notices',
         'Panel upgrades, LED lighting retrofit, and EV charging station installation across three school buildings.'),

        ('Machesney Park Riverwalk Concrete Repair','Bid','Concrete','Machesney Park, IL',
         '2025-01-22','2025-02-20',95000,
         'Lisa Navarro','lnavarro@machesneypark.org','815-877-5432',
         'https://www.machesneypark.org/government/purchasing',
         'Concrete sidewalk and retaining wall repairs along the Riverwalk trail system. ADA compliance required.'),

        ('Rockford Water Reclamation District Pump Station','Bid','Plumbing','Rockford, IL',
         '2025-01-25','2025-03-10',1200000,
        ...
        ('Cherry Valley Library Addition - Framing','Permit','General Construction','Cherry Valley, IL',
         '2025-01-28','2025-04-01',340000,
         'Tom Bauer','tbauer@cherryvalleyil.org','815-332-3441',
         'https://www.cherryvalleyil.org',
         'Structural framing for 4,200 sq ft library addition. Steel and wood hybrid construction.'),

        ('Winnebago County Highway Dept - Bridge Painting','Bid','Painting','Winnebago County, IL',
         '2025-02-01','2025-03-15',75000,
         'Paul Kimura','pkimura@wincoil.us','815-319-4300',
         'https://www.wincoil.us/Government/Purchasing-Department/Open-Bids-Quotes-RFPs/',
         'Sandblasting and repainting of three county highway bridges. Lead paint abatement protocols required.'),

        ('Rockford Park District Field House Flooring','Bid','Flooring','Rockford, IL',
         '2025-02-03','2025-03-20',128000,
         'Angela Morris','amorris@rockfordparkdistrict.org','815-987-8800',
         'https://www.rockfordparkdistrict.org/about-rpd/rfp-contracts-bids/',
         'Removal and replacement of gymnasium hardwood floor and rubberized track surface in the Beyer Field House.'),

        ('Roscoe Water Main Replacement - Phase 2','Bid','Plumbing','Roscoe, IL',
         '2025-02-05','2025-03-25',890000,
         'Nancy Fitch','nfitch@villageofroscoe.com','815-623-2700',
         'https://www.villageofroscoe.com',
         'Replacement of 3,200 LF of aging 6-inch cast iron water main with 8-inch ductile iron. Includes service reconnections.'),

        ('Rockford Public Schools - Masonry Tuckpointing','RFP','Masonry','Rockford, IL',
         '2025-02-08','2025-04-10',215000,
         'Greg Olson','golson@rps205.net','815-966-3000',
         'https://www.rps205.net/departments/finance-a/purchasing-a',
        ...
        ('Loves Park Street Resurfacing - Zone 4','Bid','Paving','Loves Park, IL',
         '2025-02-10','2025-03-30',530000,
         'Dan Stokes','dstokes@lovespark.us','815-654-5033',
         'https://www.lovespark.us',
         'Hot mix asphalt resurfacing of 18 residential streets in Zone 4. Includes crack sealing and curb repair.'),

        ('Winnebago County Animal Services Facility - HVAC','Bid','HVAC','Rockford, IL',
         '2025-02-12','2025-04-05',165000,
